...
class CardinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True, lm: bool = False):
        ...
        # exact 100 → நூறு
        exact_hundred = pynutil.add_weight(
            pynini.union(
        ...
        # 110-199
        graph_hundreds |= (pynini.cross("1", "நூற்று") | pynini.cross("௧", "நூற்று")) + pynutil.insert(" ") + teens_ties
        # 201-209 ... 901-909
        ...
        graph_hundreds_of_crores |= create_larger_number_graph(
            exact_hundred, suffix_crores_tail, 2, graph_ten_thousands
        )
        ...
        graph_hundreds_of_crores |= create_larger_number_graph(
            graph_hundreds, suffix_crores_tail, 2, graph_ten_thousands
        )
        ...
        graph_thousands_of_crores |= create_larger_number_graph(
            graph_thousands, suffix_crores_tail, 3, graph_thousands
        )
        graph_thousands_of_crores |= create_larger_number_graph(
            graph_thousands, suffix_crores_tail, 2, graph_ten_thousands
        )
        graph_thousands_of_crores |= create_larger_number_graph(graph_thousands, suffix_crores_tail, 1, graph_lakhs)
        graph_thousands_of_crores |= create_larger_number_graph(
            graph_thousands, suffix_crores_tail, 0, graph_ten_lakhs
        )
        ...
        graph_ten_thousands_of_crores |= create_larger_number_graph(
            graph_ten_thousands, suffix_crores_tail, 6, single_digit
        )
        graph_ten_thousands_of_crores |= create_larger_number_graph(
            graph_ten_thousands, suffix_crores_tail, 5, teens_ties
        )
        graph_ten_thousands_of_crores |= create_larger_number_graph(
            graph_ten_thousands, suffix_crores_tail, 4, graph_hundreds
        )
        graph_ten_thousands_of_crores |= create_larger_number_graph(
            graph_ten_thousands, suffix_crores_tail, 3, graph_thousands
        )
        graph_ten_thousands_of_crores |= create_larger_number_graph(
            graph_ten_thousands, suffix_crores_tail, 2, graph_ten_thousands
        )
        graph_ten_thousands_of_crores |= create_larger_number_graph(
            graph_ten_thousands, suffix_crores_tail, 1, graph_lakhs
        )
        graph_ten_thousands_of_crores |= create_larger_number_graph(
            graph_ten_thousands, suffix_crores_tail, 0, graph_ten_lakhs
        )
        ...
        graph_ten_lakhs_of_crores |= create_larger_number_graph(
            graph_ten_lakhs, suffix_crores_tail, 3, graph_thousands
        )
        graph_ten_lakhs_of_crores |= create_larger_number_graph(
            graph_ten_lakhs, suffix_crores_tail, 2, graph_ten_thousands
        )
        graph_ten_lakhs_of_crores |= create_larger_number_graph(graph_ten_lakhs, suffix_crores_tail, 1, graph_lakhs)
        graph_ten_lakhs_of_crores |= create_larger_number_graph(
            graph_ten_lakhs, suffix_crores_tail, 0, graph_ten_lakhs
        )
        ...
        graph_ten_crores_of_crores |= create_larger_number_graph(
            graph_ten_crores, suffix_crores_tail, 4, graph_hundreds
        )
        graph_ten_crores_of_crores |= create_larger_number_graph(
            graph_ten_crores, suffix_crores_tail, 3, graph_thousands
        )
        graph_ten_crores_of_crores |= create_larger_number_graph(
            graph_ten_crores, suffix_crores_tail, 2, graph_ten_thousands
        )
        graph_ten_crores_of_crores |= create_larger_number_graph(graph_ten_crores, suffix_crores_tail, 1, graph_lakhs)
        graph_ten_crores_of_crores |= create_larger_number_graph(
            graph_ten_crores, suffix_crores_tail, 0, graph_ten_lakhs
        )
